...
attachPane : function (childNode) {
	...
	if ( this.attachPoint.addChild ) {
		...
		console.log("Common.Util.attachPane    DOING this.attachPoint.appendChild");
...
fetchSyncJson : function(url, timeout) {
    ...
    dojo.xhrGet({
        ...
        // The error handler
        error: function() {
            console.log("plugins.core.Common.fetchSyncJson    Error, response: " + dojo.toJson(response));
        }
    });
