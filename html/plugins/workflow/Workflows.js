...
console.log("Loading plugins/workflow/Workflows");

define("plugins/workflow/Workflows", [
	"dojo/_base/declare",
	"dojo/_base/lang",
	"dijit/_Widget",
...
return declare("plugins/workflow/Workflows",
...
startup : function () {
	...
	console.log("Workflows.startup    attachPoint: " + this.attachPoint);		
	this.attachPane();
...
_updateDropTargetStageRows : function (stages, allNodes) {
	...
	dojo.forEach(allNodes, function (node, i)
	{
		...
		var stageRow = new StageRow(stages[i]);
...
// OVERLOAD THIS TO PASS ADDITIONAL ARGUMENTS TO Parameters.load()
	...
	console.log("Workflows.loadParametersPane    stageObject.application: ");
	console.dir({application:stageObject.application});
