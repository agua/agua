...
define("plugins/workflow/StageMenu", [
	"dojo/_base/declare",
	"dijit/_Widget",
	"dijit/_Templated",
	"plugins/core/Common",
...
return declare("plugins/workflow/StageMenu",
...
// ADD PROGRAMMATIC CONTEXT MENU
	...
	// START run
	this.core.runStatus.runWorkflow();
},
chain : function () {
...
// OF THE PRECEDING STAGE
	...
	this.core.userWorkflows.loadParametersPane(node.application);
},
refresh : function () {
