...
define("plugins/workflow/Parameters", [
	"dojo/_base/declare",
	"dojo/_base/lang",
	"dijit/_Widget",
...
return declare("plugins/workflow/Parameters",
...
loadTitlePane : function (paneType, shared) {
	...
	console.log("Parameters.loadTitlePane    stageObject:" + dojo.toJson(stageObject, false));
